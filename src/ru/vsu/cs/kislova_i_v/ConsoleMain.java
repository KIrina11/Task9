    ...
    public static void main(String[] args) throws Exception {
        ...
        if (params.window) {
            ...
            if (list == null) {
                ...
                ArrayUtils.writeListToFile(params.outputFile, SortPositiveNumbersInAscendingOrder.sortPositiveNumbersInAscendingOrder(list));
            }
            out.println(SortPositiveNumbersInAscendingOrder.sortPositiveNumbersInAscendingOrder(list));
            out.close();
        }
    }
}
